...
const EditIncident = ({ selectedIncident }) => {
  ...
  useEffect(() => {
    ...
    setFormData({
      inspection_id: selectedIncident.inspection_id ?? null,
      asset_id: selectedIncident.asset_id ?? null,
      question_id: selectedIncident.question_id ?? null,
      vendor_id: selectedIncident.vendor_id ?? null,
      response_id: selectedIncident.response_id ?? null,
  ...
  return (
    <div className="modal fade" id="edit-incident" tabIndex="-1">
