                    ...
                    <div className="bg-dark rounded text-center position-relative p-4">
                      ...
                      <div className="box-bg">
                        <span className="bg-right">
                          <ImageWithBasePath src={emailbg01} alt="Img" />
                        </span>
                        <span className="bg-left">
                          <ImageWithBasePath src={emailbg02} alt="Img" />
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="list-group list-group-flush mails-list">
                      <div className="list-group-item border-bottom p-3">
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                          <div className="d-flex align-items-center">
                            <span className="d-flex align-items-center btn btn-sm bg-transparent-dark text-dark me-2">
                              <i className="ti ti-folder-open me-2" />3
                            </span>
                            <span className="d-flex align-items-center btn btn-sm bg-transparent-dark text-dark">
                          ...
                          <div className="d-flex align-items-center">
                            ...
                            <span className="badge shadow-none badge-soft-info mx-2">
                      ...
                      <div className="list-group-item border-bottom p-3">
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                          ...
                          <div className="d-flex align-items-center">
                            ...
                            <span className="badge shadow-none badge-soft-purple mx-2">
                              <i className="ti ti-square me-1" />
                              Applications
                            </span>
                            <Link
                      ...
                      <div className="list-group-item border-bottom p-3">
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                          <div className="d-flex align-items-center">
                            <span className="d-flex align-items-center btn btn-sm bg-transparent-dark text-dark fs-14">
                          ...
                          <div className="d-flex align-items-center">
                            ...
                            <span className="badge shadow-none badge-soft-danger mx-2">
                              <i className="ti ti-square me-1" />
                              External
                            </span>
                            <Link
                      ...
                      <div className="list-group-item border-bottom p-3">
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                          ...
                          <div className="d-flex align-items-center">
                            <span className="badge shadow-none badge-soft-success">
                              <i className="ti ti-square me-1" />
                              Team Events
                            </span>
                          </div>
                      ...
                      <div className="list-group-item border-bottom p-3">
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                          ...
                          <div className="d-flex align-items-center">
                            <span className="badge shadow-none badge-soft-danger me-2">
                              <i className="ti ti-square me-1" />
                              External
                            </span>
                            <Link
                      ...
                      <div className="list-group-item border-bottom p-3">
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                          ...
                          <div className="d-flex align-items-center">
                            <span className="badge shadow-none badge-soft-warning me-2">
                              <i className="ti ti-square me-1" />
                              Work
                            </span>
                            <Link
                      ...
                      <div className="list-group-item border-bottom p-3">
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                          ...
                          <div className="d-flex align-items-center">
                            <span className="badge shadow-none badge-soft-info shadow-none">
                              <i className="ti ti-square me-1" />
                              Projects
                            </span>
                          </div>
